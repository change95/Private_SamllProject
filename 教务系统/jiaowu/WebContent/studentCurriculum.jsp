...
<body>
	   ...
	   <%
		   ...
		   String sql="SELECT * FROM curriculum,teacher,student WHERE curriculum.tno=teacher.tno AND student.class=curriculum.classnum AND student.sno="+tno;//设置sql语句
