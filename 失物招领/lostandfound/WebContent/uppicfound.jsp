...
<div style=" height: 400px" >
		...
		<h1>上传招领照片</h1>
			...
			<div style="margin: 0 auto; height: 400px ; width: 400px;  text-align: left: ;  ">
				...
				<br><b>流程:填写招领信息表  -->  上传图片 -->  完成</b><br><br><br>
				照片ID号:<%=(String)session.getAttribute("foundpic") %><br><br>
				当前上传图片:
				<form action="/lostandfound/UploadServlet?way=found" enctype="multipart/form-data" method="post">
