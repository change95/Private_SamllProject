...
<div style=" height: 700px" >
		...
		<h1>发布招领启事</h1>
			...
			<div style="margin: 0 auto; height: 100%; ; width: 400px;  text-align: left;  ">
				<form method="post" action="/lostandfound/BaseServlet?method=found">
					...
					<br>
					拾取地点:<input name="place" type="text" style=" margin-top: 20px; width: 200px; height: 20px;"> 
					<br>
					拾取时间:<input id="time" name="time" type="text" style=" margin-top: 20px; width: 200px; height: 20px;">
					<br>
					...
					<br>
					类型:<input type="text" name="type" readonly="readonly" value="found" style="background-color: gray;">
					<br>
					<br>
