...
<div class="wrap" id="wrap">
	<div class="logGet">
			...
			<form action="/lostandfound/adminServlet?method=adminlogin" method="post">
			<!-- 头部提示信息 -->
			...
			<div class="logC">
				<a style="cursor: pointer;"><button type="submit">登 录</button></a>
			</div>
			</form>
		</div>
</div>
...
<div class="footer" id="foot">
  <div class="copyright">
    ...
    <div class="img">
		<i class="icon"></i><span>联系邮箱：6666666@qq.com</span>
	</div>
	
	<div class="img">
		<i class="icon1"></i><span>联系地址：内蒙古大学创业学院</span>
	</div>
	  
	<div class="img">
	  <i class="icon2"></i><span>联系电话：8888888</span>
	</div>
